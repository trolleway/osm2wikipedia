...
<qgis labelsEnabled="0" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|AttributeTable" version="3.22.2-Białowieża">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{4a38362d-621b-4125-8fe2-3b9129a25fac}">
      <rule key="{bb9b8fd5-e06d-4711-82fb-9cd6080e720c}" symbol="0"/>
    </rules>
    <symbols>
      <symbol type="line" clip_to_extent="1" name="0" force_rhr="0" alpha="1">
        ...
        <layer locked="1" enabled="1" class="SimpleLine" pass="1">
          <Option type="Map">
            ...
            <Option type="QString" value="45,45,45,255" name="line_color"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="start_date_date"/>
    <field configurationFlags="None" name="end_date_date"/>
  </fieldConfiguration>
  <aliases>
    ...
    <alias name="" field="bridge" index="9"/>
    <alias name="" field="tunnel" index="10"/>
    <alias name="" field="service" index="11"/>
    <alias name="" field="usage" index="12"/>
    <alias name="" field="start_date" index="13"/>
    <alias name="" field="end_date" index="14"/>
    <alias name="" field="z_order" index="15"/>
    <alias name="" field="other_tags" index="16"/>
    <alias name="" field="start_date_date" index="17"/>
    <alias name="" field="end_date_date" index="18"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="start_date_date" expression=""/>
    <default applyOnUpdate="0" field="end_date_date" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" field="waterway" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="aerialway" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="barrier" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="man_made" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="railway" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="bridge" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="tunnel" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="service" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="usage" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="start_date" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="end_date" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="z_order" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="other_tags" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="start_date_date" unique_strength="0" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" field="end_date_date" unique_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="start_date_date" desc="" exp=""/>
    <constraint field="end_date_date" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="end_date" hidden="0" width="-1"/>
      <column type="field" name="z_order" hidden="0" width="-1"/>
      <column type="field" name="other_tags" hidden="0" width="-1"/>
      <column type="field" name="start_date_date" hidden="0" width="-1"/>
      <column type="field" name="end_date_date" hidden="0" width="-1"/>
