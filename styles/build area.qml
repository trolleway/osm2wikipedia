...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" labelsEnabled="0" version="3.20.3-Odense" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyLocal="1" minScale="100000000" readOnly="0">
  <flags>
  ...
  <temporal startField="" endExpression="" accumulate="0" mode="0" enabled="0" durationField="" startExpression="" durationUnit="min" fixedDuration="0" endField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="0" type="fill" alpha="1">
        ...
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="241,200,114,255"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="208,172,99,0"/>
          ...
          <prop k="outline_color" v="208,172,99,0"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory height="15" rotationOffset="270" opacity="1" diagramOrientation="Up" spacingUnit="MM" maxScaleDenominator="1e+08" backgroundColor="#ffffff" direction="0" lineSizeType="MM" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" sizeType="MM" spacingUnitScale="3x:0,0,0,0,0,0" showAxis="1" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" minimumSize="0" enabled="0" penWidth="0" backgroundAlpha="255" minScaleDenominator="0" barWidth="5" spacing="5" width="15" scaleDependency="Area">
  ...
  <DiagramLayerSettings showAll="1" priority="0" placement="1" zIndex="0" obstacle="0" dist="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="other_tags" index="2" name=""/>
    <alias field="name" index="3" name=""/>
    <alias field="place" index="4" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    <constraint field="osm_way_id" constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint field="landuse" constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint field="other_tags" constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0"/>
