...
<qgis simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" styleCategories="AllStyleCategories" version="3.20.3-Odense" simplifyLocal="1" labelsEnabled="0">
  <flags>
  ...
  <temporal enabled="0" durationField="" startExpression="" fixedDuration="0" startField="" mode="0" accumulate="0" endField="" endExpression="" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" enableorderby="0" forceraster="0">
    <rules key="{1ab96eef-26a0-4341-abae-e877bf3f9096}">
      <rule filter=" &quot;area&quot; &lt;1" checkstate="0" key="{1f9b0b6c-bfaf-42aa-a391-94636d3987e9}" label="Water area small" symbol="0"/>
      <rule filter=" &quot;area&quot; >=1" key="{94b8fe96-c848-483b-ac8d-ce3e109899c3}" label="Water area large" symbol="1"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="fill" clip_to_extent="1" name="0" alpha="1">
        ...
        <layer enabled="1" class="SimpleFill" pass="1" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="198,236,255,255" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="198,236,255,255" name="outline_color"/>
          ...
          <prop k="color" v="198,236,255,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="198,236,255,255"/>
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="9,120,171,255" name="line_color"/>
          ...
          <prop k="line_color" v="9,120,171,255"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundAlpha="255" lineSizeType="MM" opacity="1" barWidth="5" backgroundColor="#ffffff" labelPlacementMethod="XHeight" penColor="#000000" minimumSize="0" maxScaleDenominator="1e+08" rotationOffset="270" scaleDependency="Area" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" spacingUnitScale="3x:0,0,0,0,0,0" spacing="0" sizeType="MM" scaleBasedVisibility="0" spacingUnit="MM" height="15" enabled="0" diagramOrientation="Up" width="15" showAxis="0" direction="1" penWidth="0" sizeScale="3x:0,0,0,0,0,0">
  ...
  <DiagramLayerSettings obstacle="0" zIndex="0" dist="0" showAll="1" linePlacementFlags="2" placement="0" priority="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="osm_way_id" index="4" name=""/>
  </aliases>
  <defaults>
